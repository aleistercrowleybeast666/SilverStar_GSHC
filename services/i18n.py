...
ZH_CN.update(
    {
        ...
        "export.theme.label": "导出主题",
        "export.theme.follow_ui": "跟随界面",
        ...
        "export.range.page": "图片分页长度",
        "export.range.gif": "GIF 源时长（从任务起点）",
        "export.range.custom": "自定义",
        "export.range.full": "完整范围",
        "export.range.timing": "GIF 默认全程：超过 30 秒匀速压缩到 30 秒，较短则原速；画面时间为实际任务时间，末尾停留 1 秒。",
...
EN_US.update(
    {
        ...
        "export.theme.label": "Export Theme",
        "export.theme.follow_ui": "Follow UI",
        ...
        "export.range.page": "PNG page duration",
        "export.range.gif": "GIF source duration (from start)",
        "export.range.custom": "Custom",
        "export.range.full": "Full",
        "export.range.timing": "GIF defaults to the full mission: durations over 30 s play in 30 s; shorter ones play in real time. The clock shows mission time, with a 1 s final hold.",
