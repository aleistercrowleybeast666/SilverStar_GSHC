...
ZH_CN.update(
    {
        ...
        "export.range.timing": "GIF：30 fps；整个所选范围匀速播放，运动最长 30 秒，末尾停留 1 秒。",
...
EN_US.update(
    {
        ...
        "export.range.timing": "GIF: 30 fps; constant speed across the selected range, up to 30 s motion plus 1 s final hold.",
